...
(function() {
    ...
    socket.on('chat', function(msg) {
        console.log(msg.s);
        if(msg.s == 'True')
            append_chat($('<em style="color:grey">' + msg.u + '</em> &mdash; <del style="color:grey">' + msg.m + 
                '</del> &mdash; <small>This message was deleted because it raised the spam flag</small><br>'));
        else
